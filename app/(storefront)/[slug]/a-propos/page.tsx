...
export async function generateMetadata({ params }: Props) {
  ...
  return { title: `À propos — ${tenant.nomBoutique}` };
}

// Même patron de page que app/(storefront)/[slug]/page.tsx (résolution du
// thème, navbar/footer dupliqués — convention déjà établie sur toutes les
// pages storefront secondaires) : rend les blocs de config.aboutPage via le
// même CustomSectionsRenderer que la home. Un marchand qui n'a pas encore
// configuré cette page (aboutPage.actif faux ou absent) retombe sur la

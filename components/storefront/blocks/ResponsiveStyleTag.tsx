...
export function ResponsiveStyleTag({ nodeId, style, cible }: { nodeId: string; style?: BlockStyleOverrides; cible?: boolean }) {
  const css = blockResponsiveCss(nodeId, style, cible);
  if (!css) return null;
  return <StyleCss css={css} />;
}
